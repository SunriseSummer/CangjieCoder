...
- 提供 Cangjie 专用 Skills、LSP 探测/跳转/符号查询、AST 编辑、工程模板、文件/命令/构建/测试工具
...
当前这批能力已经覆盖“读文件/搜文本/创建文件/精确替换/构建测试/符号发现/定义跳转/AST 定点编辑”的首轮自主开发闭环，比较适合通过 stdio MCP 接入到 OpenCode、Copilot 等宿主中做首轮试用。
